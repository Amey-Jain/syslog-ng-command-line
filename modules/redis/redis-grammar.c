...
{
       0,   353,   353,   352,   360,   361,   365,   370,   374,   379,
     384,   389,   390,   391,   391,   604,   611,   624,   624,   630,
     631,   773,   781,   782,   783,   860,   861,   861,   862,   863,
     864
};
#endif
...
static const char *const yytname[] =
{
  ...
  "template_content_inner", "template_content", "$@12", "string",
...
{
       5,  -126,    12,  -127,  -127,  -125,   -67,  -123,  -119,  -114,
    -113,  -127,  -112,  -110,  -108,   -67,   -63,  -127,  -127,   -89,
     -87,   -83,  -111,   -82,  -111,  -127,  -127,  -103,  -101,  -100,
     -99,   -98,   -97,  -127,   -96,   -95,   -94,  -127,  -127,   -93,
     -92,  -127,  -111,   -74,  -111,  -111,  -111,  -111,  -127,  -127,
    -127,  -127,  -127,   -90,  -109,   -88,   -86,   -85,   -84,   -81,
     -80,  -127,   -79,   -77,  -127,  -127,  -127,  -127,  -127,  -127,
    -127,  -127,  -127,   -76,  -111,  -127,   -75,  -127
};
...
{
    -127,  -127,  -127,    38,  -127,  -127,  -127,   -49,  -127,   -23,
    -127,  -127,  -127
};
...
static const yytype_int8 yytable[] =
{
      ...
      45,    46,    47,    56,    48,    49,    50,    51,    52,    11,
      61,    76,    66,    26,    67,    68,    69,     0,     0,    70,
      71,    72,    74,     0,    75,    77,     0,     0,     0,    12,
       0,    13,    32,    -5
};

static const yytype_int16 yycheck[] =
{
      67,    24,    65,    66,    53,   116,    73,   116,   119,     4,
     119,   137,     0,    62,   139,    78,   139,    80,    81,    42,
     139,    44,    45,    46,    47,   139,   139,   139,   117,   139,
     117,    54,   140,   100,   117,   117,   139,   104,   139,   139,
     139,   139,   139,   117,   140,   140,   140,   140,   140,   116,
     140,    74,   140,    15,   140,   140,   140,    -1,    -1,   140,
     140,   140,   139,    -1,   140,   140,    -1,    -1,    -1,   136,
      -1,   138,   135,   140
};
...
{
       0,     4,   146,   137,     0,   147,   139,    67,    73,   100,
     104,   116,   136,   138,   148,   149,   150,   155,   156,   139,
     139,   139,   139,   139,   139,   140,   148,    65,    66,    78,
      80,    81,   135,   157,   117,   117,   117,   116,   119,   154,
     117,   154,   139,   139,   139,   139,   139,   139,   140,   140,
     140,   140,   140,   152,   153,   154,   117,   154,   154,   154,
     154,   140,   152,   116,   151,   154,   140,   140,   140,   140,
     140,   140,   140,   152,   139,   140,   154,   140
};
...
#line 281 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2497 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;

    case 119: /* LL_STRING  */
#line 281 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2503 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;

    case 121: /* LL_BLOCK  */
#line 281 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2509 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;

    case 154: /* string  */
#line 281 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2515 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 353 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            last_driver = *instance = redis_dd_new(configuration);
          }
#line 2811 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 356 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2817 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 6:
#line 366 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_host(last_driver, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
          }
#line 2826 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 371 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_port(last_driver, (yyvsp[-1].num));
          }
#line 2834 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 375 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
...
#line 2843 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
  ...
  case 9:
#line 380 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_command(last_driver, (yyvsp[-3].cptr), (yyvsp[-2].ptr), (yyvsp[-1].ptr), NULL);
            free((yyvsp[-3].cptr));
          }
#line 2852 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 385 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_command(last_driver, (yyvsp[-4].cptr), (yyvsp[-3].ptr), (yyvsp[-2].ptr), (yyvsp[-1].ptr));
            free((yyvsp[-4].cptr));
          }
#line 2861 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 13:
#line 391 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options = redis_dd_get_template_options(last_driver); }
#line 2867 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 15:
#line 605 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
          GError *error = NULL;
...
#line 2878 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 612 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
          GError *error = NULL;
...
#line 2892 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 624 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template = log_template_new(configuration, NULL); }
#line 2898 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 18:
#line 624 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_template; }
#line 2904 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 21:
#line 774 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
          log_threaded_dest_driver_set_max_retries(last_driver, (yyvsp[-1].num));
        }
#line 2912 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 22:
#line 781 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { ((LogDestDriver *) last_driver)->log_fifo_size = (yyvsp[-1].num); }
#line 2918 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 23:
#line 782 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { ((LogDestDriver *) last_driver)->throttle = (yyvsp[-1].num); }
#line 2924 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 24:
#line 784 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            Plugin *p;
...
#line 2946 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 25:
#line 860 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->ts_format = cfg_ts_format_value((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2952 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 26:
#line 861 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->frac_digits = (yyvsp[-1].num); }
#line 2958 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 27:
#line 861 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_SEND] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2964 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 28:
#line 862 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_SEND] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2970 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 29:
#line 863 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_LOCAL] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2976 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 30:
#line 865 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
          gint on_error;
...
#line 2993 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 946 "modules/redis/redis-grammar.y" /* yacc.c:1906  */
