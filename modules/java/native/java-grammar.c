...
{
       0,   359,   359,   358,   366,   367,   371,   376,   381,   382,
     383,   384,   385,   385,   389,   390,   394,   632,   633,   775,
     783,   784,   785,   862,   863,   863,   864,   865,   866
};
#endif
...
{
      -3,  -135,     3,  -136,  -136,  -131,   -67,  -130,  -128,  -127,
    -136,  -126,  -125,  -123,  -120,  -119,   -67,   -61,  -136,  -136,
     -95,   -93,  -107,   -92,  -107,  -107,   -90,  -136,  -136,  -115,
    -114,  -110,  -105,  -104,  -103,  -136,  -102,  -101,  -136,  -136,
    -100,   -99,   -98,   -97,   -80,   -96,   -90,  -107,   -70,  -107,
    -107,  -107,  -107,  -136,  -136,  -136,  -136,  -136,  -136,  -136,
    -136,  -136,   -94,   -91,   -89,   -88,   -87,   -86,  -136,  -136,
    -136,  -136,  -136,  -136
};
...
{
    -136,  -136,  -136,    34,  -136,  -136,     6,  -136,   -17,  -136,
    -136,  -136
};
...
static const yytype_int8 yytable[] =
{
      ...
      53,    54,    55,    56,    57,    58,    60,    63,    68,    10,
      28,    69,    61,    70,    71,    72,    73,     0,     0,     0,
...
{
      67,     4,   137,     0,    65,    66,    73,    24,    25,   116,
     141,   141,   119,   141,   141,   141,   141,    78,   141,    80,
      81,   141,   117,   142,   117,   117,   141,   141,    95,   119,
      47,   141,    49,    50,    51,    52,   141,   141,   141,   119,
     142,   142,   142,   142,   142,   142,   142,   117,   142,   116,
      16,   142,    46,   142,   142,   142,   142,    -1,    -1,    -1,
...
{
       0,     4,   148,   137,     0,   149,   141,    67,    73,    95,
     116,   136,   138,   139,   140,   150,   151,   152,   156,   157,
     141,   141,   141,   141,   141,   141,   141,   142,   150,    65,
      66,    78,    80,    81,   135,   158,   117,   117,   116,   119,
     155,   117,   155,   155,   119,   153,   154,   141,   141,   141,
     141,   141,   141,   142,   142,   142,   142,   142,   142,   119,
     142,   153,   155,   117,   155,   155,   155,   155,   142,   142,
     142,   142,   142,   142
};
...
#line 285 "modules/java/native/java-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2501 "modules/java/native/java-grammar.c" /* yacc.c:1257  */
        break;

    case 119: /* LL_STRING  */
#line 285 "modules/java/native/java-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2507 "modules/java/native/java-grammar.c" /* yacc.c:1257  */
        break;

    case 121: /* LL_BLOCK  */
#line 285 "modules/java/native/java-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2513 "modules/java/native/java-grammar.c" /* yacc.c:1257  */
        break;

    case 155: /* string  */
#line 285 "modules/java/native/java-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2519 "modules/java/native/java-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 359 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    {
            last_driver = *instance = java_dd_new(configuration);
          }
#line 2815 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 362 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2821 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 6:
#line 372 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    {
          	java_dd_set_class_path(last_driver, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
          }
#line 2830 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;
...
#line 2839 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 381 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { java_dd_set_template_string(last_driver, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2845 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 385 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { last_template_options = java_dd_get_template_options(last_driver); }
#line 2851 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;
...
#line 2857 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 19:
#line 776 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    {
          log_threaded_dest_driver_set_max_retries(last_driver, (yyvsp[-1].num));
        }
#line 2865 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 20:
#line 783 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { ((LogDestDriver *) last_driver)->log_fifo_size = (yyvsp[-1].num); }
#line 2871 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;
...
#line 2877 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
  ...
  case 22:
#line 786 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    {
            Plugin *p;
...
#line 2899 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 23:
#line 862 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { last_template_options->ts_format = cfg_ts_format_value((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2905 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 24:
#line 863 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { last_template_options->frac_digits = (yyvsp[-1].num); }
#line 2911 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 25:
#line 863 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_SEND] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2917 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 26:
#line 864 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_SEND] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2923 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 27:
#line 865 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_LOCAL] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2929 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
    break;

  case 28:
#line 867 "modules/java/native/java-grammar.y" /* yacc.c:1646  */
    {
          gint on_error;
...
#line 2946 "modules/java/native/java-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 948 "modules/java/native/java-grammar.y" /* yacc.c:1906  */
